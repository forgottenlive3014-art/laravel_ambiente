...
<head>
    ...
    <style>
        ...
        .logo { text-align: center; font-size: 2rem; font-weight: 800; color: #1a4731; margin-bottom: 10px; }
        .logo span { color: #52b788; }
        h3 { text-align: center; font-weight: 800; color: #1a4731; }
        .subtitle { text-align: center; color: #6b8c78; margin-bottom: 30px; }
        .form-control, .form-select { border-radius: 10px; padding: 12px; border: 1.5px solid #c8e6d1; }
        .form-control:focus, .form-select:focus { border-color: #52b788; box-shadow: 0 0 0 3px rgba(82,183,136,0.15); }
        .btn-success { background: #2d6a4f; border-radius: 50px; padding: 12px; font-weight: 700; width: 100%; }
        .btn-success:hover { background: #1a4731; }
    </style>
</head>
<body>
<div class="auth-card">
