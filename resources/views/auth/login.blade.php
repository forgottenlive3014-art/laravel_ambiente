...
<head>
    ...
    <style>
        ...
        h3 { text-align: center; font-weight: 800; color: #1a4731; margin-bottom: 5px; }
        .subtitle { text-align: center; color: #6b8c78; margin-bottom: 30px; }
        .form-control { border-radius: 10px; padding: 12px; border: 1.5px solid #c8e6d1; }
        .form-control:focus { border-color: #52b788; box-shadow: 0 0 0 3px rgba(82,183,136,0.15); }
        .btn-success { background: #2d6a4f; border: none; border-radius: 50px; padding: 12px; font-weight: 700; width: 100%; }
