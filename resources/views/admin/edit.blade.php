        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header bg-warning">
                    <h4>Editar Dato Ambiental: {{ $dato->department }}</h4>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.environmental.update', $dato->id) }}">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="department" id="department" 
                                       ...
                                       value="{{ old('department', $dato->department) }}" required>
                                @error('department')
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="municipality" id="municipality" 
                                       ...
                                       value="{{ old('municipality', $dato->municipality) }}" required>
                                @error('municipality')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.1" name="temperature" id="temperature" 
                                       ...
                                       value="{{ old('temperature', $dato->temperature) }}" required>
                                @error('temperature')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="humidity" id="humidity" 
                                       ...
                                       value="{{ old('humidity', $dato->humidity) }}" required>
                                @error('humidity')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.01" name="co2_levels" id="co2_levels" 
                                       ...
                                       value="{{ old('co2_levels', $dato->co2_levels) }}" required>
                                @error('co2_levels')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="air_quality" id="air_quality" 
                                    ...
                                    <option value="buena" {{ old('air_quality', $dato->air_quality) == 'buena' ? 'selected' : '' }}>Buena</option>
                                    <option value="regular" {{ old('air_quality', $dato->air_quality) == 'regular' ? 'selected' : '' }}>Regular</option>
                                    <option value="mala" {{ old('air_quality', $dato->air_quality) == 'mala' ? 'selected' : '' }}>Mala</option>
                                </select>
                                @error('air_quality')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="record_date" id="record_date" 
                                       ...
                                       value="{{ old('record_date', $dato->record_date) }}" required>
                                @error('record_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="recommendations" id="recommendations" rows="3" 
                                      class="form-control @error('recommendations') is-invalid @enderror" required>{{ old('recommendations', $dato->recommendations) }}</textarea>
